# UBC-CICxSapienML COVID-19 L3-Net: Phase 3
## Introduction
...
The phase 3 model, like the phase 2 model, is based on the 2D UNet. Weights were initialized with the phase 2 model weights but trained to output 5 classes:
- 0: Background
- 1: Vessels
